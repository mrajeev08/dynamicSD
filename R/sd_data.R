#' @export
#' @import raster fasterize
#' @importFrom magrittr %<>%
#' @importFrom dplyr mutate distinct summarize filter left_join group_by arrange
#'
get_sd_pops <- function(sd_shapefile, res_m, sd_census_data, death_rate_annual) {
  ...
  rast <-
    setup_space(shapefile = sd_shapefile,
