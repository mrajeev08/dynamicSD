...
summ_stat_labs <- 
  tribble(~summstat, ~lab, ~descr, ~type, 
          ...
          "mean_dist_8wks", "Mean distance 8 weeks","Mean distance between cases within an 8 week window", "Spatiotemporal",
          "mean_dist_4wks_norm", "Mean distance 4 weeks normalized", "Mean distances of cases within an 4 week window, normalized by the average distance between all cases", "Spatiotemporal",
          "mean_dist_8wks_norm", "Mean distance 8 weeks normalized", "Mean distances of cases within an 8 week window, normalized by the average distance between all cases", "Spatiotemporal", 
          ...
          NA, "ACF Monthly 1-6", "Autocorrelation values for monthly time series at 1 - 6 month lag", "Temporal",
          NA, "ACF Weekly 1-10", "Autocorrelation values for weekly time series at 1 - 10 week lag", "Temporal",
